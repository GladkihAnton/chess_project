...
import lightRookLogo from "../../../../../images/chess_figures/light_rook.png";
import darkRookLogo from "../../../../../images/chess_figures/dark_rook.png";
    ...
    render() {
        return (
            <button className={style.clickable_cell}
                ...
                <img className={style.logo} src={this.color === 'black' ? darkRookLogo : lightRookLogo}/>
            </button>
        )
    }
...
export default connect(mapStateToProps, actions)(Rook)
